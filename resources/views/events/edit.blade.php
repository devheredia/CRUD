...
<form action="{{ route('events.update',$event->id) }}" method="POST">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <strong>Local:</strong>
            <input type="text" name="local" value="{{ $event->local}}" class="form-control" placeholder="Digite o Endereço">
        </div>

        <div class="form-group">
            <strong>Data:</strong>
            <input type="date" name="date" value="{{ $event->date}}" class="form-control" placeholder="00/00/0000">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
            ...
            <input type="text" name="status" value="{{ $event->status}}" class="form-control" placeholder="Status">
        </div>
